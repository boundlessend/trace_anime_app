...
- Поиск по URL изображения, буферу обмена, drag and drop, локальному файлу или захвату области экрана через глобальный хоткей (Option+Cmd+S).
- Воспроизведение превью прямо в результатах поиска.
- Открытие совпадений на AniList или MyAnimeList и копирование данных результата.
- Избранное и история поисков (с удалением записи и очисткой всей) с исходной картинкой.
